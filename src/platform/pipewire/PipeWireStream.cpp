...
void PipeWireStream::updateVolumeFromProps(const spa_pod* param){
...
void PipeWireStream::on_param(void *data, int seq, int32_t id, uint32_t index, uint32_t next, const struct spa_pod *param){
